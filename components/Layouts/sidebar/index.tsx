...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 h-screen max-w-[290px] overflow-hidden border-r border-gray-200 bg-white transition-[width] duration-200 ease-linear dark:border-gray-800 dark:bg-gray-dark",
        isOpen ? "w-full" : "w-0",
      )}
